...
//             //     supabase.rpc('get_user_dashboard_stats', {
//             //         user_id: user.id
//             //     }),
//             //     supabase
//             //         .from('loans')
...
//
//             if (loansData) {
//                 setBorrowedBooks(loansData.map(loan => ({
//                     id: loan.loan_id,
//                     title: loan.books?.title || '',
//                     author: loan.books?.author || '',
//                     due_date: loan.due_date,
...
export default function Dashboard() {
    ...
    const fetchDashboardData = useCallback(async () => {
        ...
        try {
            ...
            //         borrowed_count:id(count),
            //         overdue_count:id(count)
            //     `)
            //     .eq('user_id', user.id)
            //     .eq('status', 'borrowed')
            //     .or(`and(status.eq.borrowed,due_date.lt.${new Date().toISOString()})`)
            //     .single();
            //
            // if (statsQuery.error) {
            ...
            //         borrowedbooks: statsQuery.data.borrowed_count || 0,
            //         overduebooks: statsQuery.data.overdue_count || 0
            //     });
            // }
